...
export default defineConfig({
  ...
  integrations: [
    universityTheme({
      ...
      // a11y-fixes.css loads after slop.css: re-darkens two semantic tokens
      // the theme forgot to for light mode, and restores a focus-visible
      // ring the theme's own `all: unset` reset strips from one button ---
